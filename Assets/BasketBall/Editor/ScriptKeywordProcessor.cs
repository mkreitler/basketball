...
internal sealed class ScriptKeywordProcessor : UnityEditor.AssetModificationProcessor {
    ...
    private const string company1 = "Think Again Games";
    private const string websiteUrl1 = " - http://www.thinkagaingames.com";
    ...
    public static void OnWillCreateAsset(string path) {
        ...
        file = file.Replace("#DEVELOPERNAME#", "Mark Kreitler - markkreitler@protonmail.com");
